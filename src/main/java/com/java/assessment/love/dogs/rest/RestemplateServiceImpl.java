...
public class RestemplateServiceImpl {
    ...
    public ResponseEntity<Void> postFile(String url, MultipartFile file, Map<String, Object> queryParams) throws IOException {
        try {
            ...
            ByteArrayResource fileAsResource = new ByteArrayResource(file.getBytes()) {
                ...
                public String getFilename() {
                    return file.getOriginalFilename() != null ? file.getOriginalFilename():"upload.png"; // important to set filename!
                }
            };
