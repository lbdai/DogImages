...
public class FileMockUtils {
  ...
  public static MockMultipartFile getMockMultipartFile(String name, String originalFilename)
    ...
    MockMultipartFile file =
        new MockMultipartFile(
            "file", originalFilename, MediaType.APPLICATION_OCTET_STREAM_VALUE, content);
    return file;
  }
}
